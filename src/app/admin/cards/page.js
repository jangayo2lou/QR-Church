...
export default function CardsPage() {
  ...
  async function captureCardDataUrl(element, pixelRatio = 3) {
    ...
    const previous = {
      ...
      backfacePriority: element.style.getPropertyPriority(
        "backface-visibility",
      ),
      webkitBackfaceVisibility: element.style.getPropertyValue(
        "-webkit-backface-visibility",
      ),
      webkitBackfacePriority: element.style.getPropertyPriority(
        "-webkit-backface-visibility",
      ),
    ...
    try {
      ...
      if (previous.backfaceVisibility) {
        element.style.setProperty(
          "backface-visibility",
          previous.backfaceVisibility,
          previous.backfacePriority,
        );
      } else {
      ...
      if (previous.webkitBackfaceVisibility) {
        element.style.setProperty(
          "-webkit-backface-visibility",
          previous.webkitBackfaceVisibility,
          previous.webkitBackfacePriority,
        );
      } else {
      ...
      <AdminShell title="Attendance Cards Optimization">
        ...
        <div className="cards-grid grid grid-cols-1 xl:grid-cols-2 gap-x-6 gap-y-12 w-full overflow-x-auto pb-12 px-4 justify-items-center items-start">
          {filtered.map((member) => {
            ...
            const profileUrl = appOrigin
              ? `${appOrigin}/m/${member.qr_token}`
              : `/m/${member.qr_token}`;
                ...
                <div className="no-print absolute top-4 left-6 z-30 flex gap-3 opacity-0 transition-opacity group-hover:opacity-100">
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      downloadAsImage(
                        `card-front-${member.id}`,
                        `Front_${member.last_name}`,
                      );
                    }}
                  ...
                  >
                    ...
                    >
                      ...
                      <header className="flex shrink-0 flex-col items-center pt-8 pb-2 relative z-10">
                        ...
                        <h3
                          ...
                          className="text-[36px] font-normal leading-none tracking-wide"
                        >
                        ...
                        <h2
                          ...
                          className="mt-2 text-[14px] font-bold tracking-[0.2em]"
                        >
                      ...
                      <main className="px-14 flex flex-1 flex-row justify-between relative mt-2 pb-24 z-10">
                        ...
                        <div className="flex gap-8 items-center h-full pt-2">
                          ...
                          {avatarUrl ? (
                            ...
                            <div
                              ...
                              className="flex shrink-0 h-[220px] w-[220px] items-center justify-center rounded-[36px] border-[3px] border-dashed border-[#dcc7a2] text-[13px] font-bold tracking-[0.1em] shadow-sm"
                            >
                              NO PHOTO
                            </div>
                          )}
                          ...
                          <div className="flex flex-col justify-center text-left max-w-[420px] break-words">
                            <p
                              style={{ color: "#9d8351" }}
                              className="text-[13px] font-bold uppercase tracking-[0.25em] mb-2.5"
                            >
                              Official Member
                            </p>
                            <h4
                              ...
                              className="text-[46px] font-bold tracking-tight leading-[1.1] break-words"
                            >
                              {member.last_name}
                            </h4>
                            <p
                              ...
                              className="text-[28px] font-bold tracking-tight mt-1 mb-6 break-words"
                            >
                        ...
                        <div className="flex flex-col justify-end items-center h-full pb-2 shrink-0">
                          ...
                          <p
                            style={{ color: "#9d8351" }}
                            className="mt-4 text-[13px] font-bold tracking-[0.3em] uppercase"
                          >
                            Valid Identity
                          </p>
                        </div>
                      ...
                      <footer
                        style={{
                          background:
                            "linear-gradient(90deg,#4d1111 0%,#7a1f1f 50%,#4d1111 100%)",
                        }}
                        className="absolute bottom-0 left-0 right-0 flex h-[58px] items-center justify-center z-20"
                      >
                        <p
                          style={{ color: "#f4e7e7" }}
                          className="text-[12px] font-bold tracking-[0.45em] uppercase text-center w-full"
                        >
                          PARISH MEMBER ID
                        </p>
                      </footer>
                    ...
                    >
                      ...
                      <header className="px-16 pt-12 pb-3 text-center shrink-0 relative z-10">
                        <h4
                          style={{ color: "#9d7b32" }}
                          className="text-[16px] font-bold uppercase tracking-[0.4em]"
                        >
                          Ministry Covenant
                        </h4>
                        <p
                          style={{ color: "rgba(90, 80, 60, 0.95)" }}
                          className="mt-6 text-[20px] italic leading-relaxed text-center px-4 font-normal"
                        >
                          &quot;Preach the word; be prepared in season and out
                          of season; correct, rebuke and encourage-with great
                          patience and careful instruction.&quot;
                          <span
                            style={{ color: "#4a3f2c" }}
                            className="block mt-5 text-[18px] font-bold not-italic"
                          >
                            — 2 Timothy 4:2
                          </span>
                        </p>
                      ...
                      <main className="flex-1 flex flex-col justify-between px-16 pt-2 pb-[120px] gap-6 relative z-10">
                        <div className="space-y-5">
                          ...
                          <ul
                            style={{ color: "#2d2518" }}
                            className="text-[16px] font-bold leading-loose space-y-1"
                          >
                            <li className="flex items-center gap-3">
                              <span>&raquo;</span> Proper Liturgical Attire is
                              mandatory.
                            </li>
                            <li className="flex items-center gap-3">
                              <span>&raquo;</span> Arrival 20 mins prior to the
                              celebration.
                            </li>
                            <li className="flex items-center gap-3">
                              <span>&raquo;</span> This card is strictly for
                              official attendance.
                            </li>
                          </ul>
                        </div>
                        ...
                        <div className="mb-2 flex items-end justify-between gap-6">
                          <div
                            ...
                            className="w-[480px] rounded-[24px] p-6 border"
                          >
                            <p
                              style={{ color: "#9d7b32" }}
                              className="text-[12px] font-bold uppercase tracking-[0.1em] mb-1.5"
                            >
                              Office of the Parish Priest
                            </p>
                            <p className="text-[16px] font-bold text-[#2d2518]">
                            ...
                            >
                              Tel: (033) 333-1234 &bull; church@local.com
                            </p>
                          </div>

                          <div className="shrink-0 flex flex-col items-center gap-1.5">
                            <div className="rounded-[16px] bg-white p-2.5 shadow-sm ring-1 ring-[#d5c3a1]">
                              <QRCode
                                value={profileUrl}
                                size={120}
                                bgColor="#ffffff"
                      ...
                      <footer
                        style={{ backgroundColor: "#dcc7a2" }}
                        className="absolute bottom-0 left-0 right-0 flex h-[56px] items-center justify-center z-20"
                      >
                        <p
                          style={{ color: "#2d2518" }}
                          className="text-[14px] font-bold tracking-[0.3em] uppercase text-center w-full"
                        >
                          FOUND? PLEASE RETURN TO PARISH OFFICE
                        </p>
                      </footer>
                    </div>
                  </div>
